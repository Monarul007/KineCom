...
class PosController extends Controller
{
    ...
    public function get_seller(Request $req){
        ...
        $get_pos_client = DB::table('sellers')->where('name', 'like', '%'.$s_text.'%')->limit(9)->get(); ?>
        ...
        foreach($get_pos_client as $row){
            ...
            $get_mobile = DB::table('users')->where('id', $user_id)->first();
    ...
    public function save_client_registration(Request $req){
        ...
        $get_client = DB::table('pos_client')->where('seller_id', $seller_id)->first();
