...
class PosPurchaseController extends Controller
{
    ...
    public function get_purchase_products(Request $req){
        ...
        $products = DB::table('products')->where('product_name', 'like', '%'.$s_text.'%')
        ...
        foreach($products as $row){
            ...
            $products_price = DB::table('purchase_details')->where('pid',  $id)->orderBy('id', 'DESC')->limit(1)->get();
...
<?php    }
    ...
    public function delete_purchase(Request $req){
        ...
        DB::table('purchase_primary')->where('pur_inv', $purinv)->delete();
        
        $get_pur_details = DB::table('purchase_details')->where('pur_inv', $purinv)->get();
        ...
        DB::table('purchase_details')->where('pur_inv', $purinv)->delete();
        
        $get_accounts = DB::table('acc_transactions')->where('description', 'like', '%'.$purinv)->get();
    ...
    public function delete_purchase_return(Request $req){
        ...
        $purchase_returns = DB::table('purchase_returns')->where('id', $id)->get();
        ...
        $get_accounts = DB::table('acc_transactions')->where('description', 'like', '%Memo '.$invoice)->get();
    ...
    public function get_purchase_invoice_details(Request $req){
        ...
        $get_invoice = DB::table('purchase_details')->join('products', 'purchase_details.pid', 'products.id')->where('purchase_details.pur_inv', '=', $s_text)->get(); 
        ...
        $get_invoice = DB::table('purchase_primary')->where('pur_inv', '=', $s_text)->first(); 
        
        if($get_invoice->sid > 0){
            
            $get_cname = DB::table('suppliers')->where('id', '=', $get_invoice->sid)->first();
