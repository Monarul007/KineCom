...
class IndexController extends Controller
{
    public function index(){
        ...
        foreach($categories as $index=>$fcat){
            $fcatid = $fcat['id'];
            $products = Products::where('cat_id',$fcatid)->limit(10)->get();
            if($index === 0){
        ...
        return view('welcome')->with(compact('banners','randomCats','bestSelling','mostPopular','category','categories','subMenuArray','featuredArray'));
    }
