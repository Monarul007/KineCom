...
class PosSalesController extends Controller
{
    ...
    public function get_products(Request $req){
        ...
        $products = DB::table('products')->where('product_name', 'like', '%'.$s_text.'%')->limit(9)->get(); ?>
...
<?php    }
    ...
    public function get_barcode(Request $req){
        $s_text = $req['s_text'];
        $products = DB::table('products')->where('barcode', '=', $s_text)->first(); 
        $data = array(
            'id' => $products->id, 
    ...
    public function get_invoice(Request $req){
        ...
        $get_invoice = DB::table('sales_invoice')->where('invoice_no', 'like', '%'.$s_text.'%')->limit(9)->get(); ?>
    ...
    public function get_invoice_details(Request $req){
        ...
        $get_invoice = DB::table('sales_invoice_details')->join('products', 'sales_invoice_details.pid', 'products.id')->where('sales_invoice_details.invoice_no', '=', $s_text)->get(); 
    ...
    public function sales_invoice_save(Request $req){
        ...
        if($paytype == 'mobile'){
            ...
            if($mobile_bank_id != 0 && $mobile_bank_acc_id == 0){
                ...
                DB::table('bank_acc')->insert(['id' => $maxmobid, 'bank_id' => $mobile_bank_id, 'acc_name' => $mobile_bank_account, 'user' => $user]);
            ...
            if($mobile_bank_id == 0){
                ...
                DB::table('bank_info')->insert(['id' => $maxbankid, 'name' => $mobile_bank, 'user' => $user]);
                
                $maxmobid = (DB::table('bank_acc')->max('id')+1);
                
                DB::table('bank_acc')->insert(['id' => $maxmobid, 'bank_id' => $maxbankid, 'acc_name' => $mobile_bank_account, 'user' => $user]);
        ...
        if($paytype == 'card'){
            ...
            if($card_bank_id != 0 && $card_bank_acc_id == 0){
                ...
                DB::table('bank_acc')->insert(['id' => $maxcardid, 'bank_id' => $card_bank_id, 'acc_name' => $card_bank_account, 'user' => $user]);
            ...
            if($card_bank_id == 0){
                ...
                DB::table('bank_info')->insert(['id' => $maxbankid, 'name' => $card_bank, 'user' => $user]);
                
                $maxcardid = (DB::table('bank_acc')->max('id')+1);
                
                DB::table('bank_acc')->insert(['id' => $maxcardid, 'bank_id' => $maxbankid, 'acc_name' => $card_bank_account, 'user' => $user]);
        ...
        if($paytype == 'check'){
            ...
            if($check_type == 'pay_account'){
                ...
                if($bank_id != 0 && $account_id == 0){
                    ...
                    DB::table('bank_acc')->insert(['id' => $maxaccountid, 'bank_id' => $bank_id, 'acc_name' => $shops_bank_account, 'user' => $user]);
                ...
                if($bank_id == 0){
                    ...
                    DB::table('bank_info')->insert(['id' => $maxbankid, 'name' => $shops_bank, 'user' => $user]);
                    
                    $maxaccountid = (DB::table('bank_acc')->max('id')+1);
                    
                    DB::table('bank_acc')->insert(['id' => $maxaccountid, 'bank_id' => $maxbankid, 'acc_name' => $shops_bank_account, 'user' => $user]);
            ...
            /////Insert into Accounts For Check Transaction
    ...
    public function get_sales_report_date(Request $req){
        ...
        $sales = DB::table('sales_invoice')->whereBetween('date', [$stdate, $enddate])->get();
    ...
    public function get_sales_return_report_date(Request $req){
        ...
        $sales = DB::table('sales_return')->join('products', 'sales_return.pid', 'products.id')->whereBetween('date', [$stdate, $enddate])->get();
