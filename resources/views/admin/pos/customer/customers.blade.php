          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <button class="btn btn-info float-right" data-toggle="modal" data-target="#addCust">+Add Customer</button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                        ...
                        <td class="text-right">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item" onclick="DeactiveConfirmation({{$customer->id}})"><i class="fas fa-power-off"></i> Deactivate</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="#"><i class="fas fa-scroll" aria-hidden="true"></i> Ledger</a>
                                    <a class="dropdown-item" href="#"><i class="fas fa-arrow-circle-up" aria-hidden="true"></i> Sales</a>
                                    <a class="dropdown-item" href="#"><i class="fas fa-paperclip" aria-hidden="true"></i> Documents & Note</a>
                                </div>
                            </div>
                        </td>
                    </tr>
  ...
  <div class="modal fade" id="addCust" tabindex="-1" role="dialog" aria-labelledby="addCustTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <form method="POST" action="{{route('set_customer')}}" accept-charset="UTF-8" id="contact_add_form" novalidate="novalidate">
            @csrf
                ...
                <div class="row">
                  <div class="col-6">
                    <div class="form-group">
                      ...
                      <input class="form-control" required="" placeholder="Enter Name..." name="inputName" type="text" id="inputName" aria-required="true">
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="form-group">
                      <label for="inputPhone">Phone:*</label>
                      <input class="form-control" required="" placeholder="Enter Phone..." name="inputPhone" type="text" id="inputPhone" aria-required="true">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-12">
                      <div class="form-group">
                        ...
                        <input class="form-control" required="" placeholder="Enter Address..." name="inputAddress" type="text" id="inputAddress" aria-required="true">
                      </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control" id="card_type" name="card_type">
                        <option selcted>Select Card Type</option>
